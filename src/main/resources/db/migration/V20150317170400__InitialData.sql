...
VALUES ('user-service', '4f7ec648a48b9d3fa239b497f7b6b4d8019697bd', null, '$2a$10$er7kPyZHaX2Js3NYQ/8xQejUR/F78hytrxNVOZd5MB5QwsIBf0BH6', 'all,read,write', 'refresh_token,authorization_code', null, 'ROLE_RESOURCE_SERVER', null, null, null, true);
...
INSERT INTO user_status(id, name, description, is_selectable) VALUES (1, "ACTIVE", "Indicates the user is active", 1);
INSERT INTO user_status(id, name, description, is_selectable) VALUES (2, "PENDING", "Indicates the user is pending", 1);
INSERT INTO user_status(id, name, description, is_selectable) VALUES (3, "SUSPENDED", "Indicates the user is suspended", 1);
INSERT INTO user_status(id, name, description, is_selectable) VALUES (4, "BLACKLISTED", "Indicates the user is blacklisted", 1);
